...
use DagaSmart\CloudStorage\Factory\CloudStorage\CloudStorageFactory;
...
trait UploadTrait
{
     ...
     * @throws Exception
     */
    public function cloudGetUrl($resource_id, $openDomain = ''): ?string
    {
        ...
        if ($info) {
            ...
            try {
                $res = $info->getCloudStoragePath($info->url, $info->storage_id);
            } catch (Exception $e) {
